import{g as U,s as q,a as K,b as V,t as Z,q as j,_ as s,l as w,c as H,F as J,K as Q,M as X,N as G,O as Y,e as ee,z as te,P as ae,G as re}from"./mermaid-vendor-CmCBYfke.js";import{p as ie}from"./chunk-4BX2VUAB-BhdKX9OM.js";import{p as se}from"./treemap-GDKQZRPO-BlxUDZwH.js";import"./feature-graph-DWP6czkC.js";import"./react-vendor-CU17ABXU.js";import"./graph-vendor-B32sdhqA.js";import"./ui-vendor-C7yrzwF6.js";import"./utils-vendor-CZXcunN-.js";import"./_baseUniq-PMOFsVm9.js";import"./_basePickBy-DxaafsWp.js";import"./clone-C6dMQXL6.js";var le=re.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,te()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),M={getConfig:ne,clear:ce,setDiagramTitle:j,getDiagramTitle:Z,setAccTitle:V,getAccTitle:K,setAccDescription:q,getAccDescription:U,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{ie(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await se("pie",e);w.debug(a),fe(a,M)},"parse")},he=s(e=>`
  .pieCircle{
